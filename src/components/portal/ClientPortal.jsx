  ...
  return (
    <div className="min-h-screen bg-[#F8F9FC] font-sans text-[#101828] flex flex-col">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto p-6 lg:p-10 space-y-6">
        ...
        {/* TAB 1: SEPARATE CLIENT WHATSAPP INBOX */}
        {activeTab === 'inbox' && (
          <div className="bg-white border border-[#EAECF0] rounded-3xl shadow-sm overflow-hidden flex flex-col h-[750px] animate-in fade-in">
            {/* Top Inbox Context Header */}
            <div className="px-6 py-3.5 border-b border-[#EAECF0] bg-[#FDFBF7]/40 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-xl bg-[#22C55E]/10 text-[#16A34A] flex items-center justify-center">
                  <Mail className="w-4 h-4" />
                </div>
                <div>
                  <div className="flex items-center gap-2">
                    <h2 className="text-sm font-bold text-[#101828]">Kiki Client WhatsApp Inbox</h2>
                    <span className="px-2 py-0.5 rounded-full text-[10px] font-mono font-bold bg-[#DCFCE7] text-[#15803D] border border-[#BBF7D0]">
                      ISOLATED CLIENT SESSION
                    </span>
                  </div>
                  <p className="text-[11px] text-[#667085]">
                    Connected to Phone ID: <span className="font-mono text-[#101828] font-bold">{phoneNumberId ? phoneNumberId.slice(0, 10) + '...' : '1349867994...'}</span> · Zero CRM crossover
                  </p>
                </div>
              </div>
            ...
            <div className="flex-1 flex overflow-hidden">
              ...
              <div className="w-80 md:w-96 border-r border-[#EAECF0] flex flex-col bg-white shrink-0">
                {/* Search & Filter Bar */}
                <div className="p-3 border-b border-[#EAECF0] space-y-2">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-8.5 pr-7 py-1.5 bg-[#F9FAFB] border border-[#EAECF0] rounded-xl text-xs focus:ring-2 focus:ring-[#7C3AED] focus:bg-white focus:outline-none"
                    />
                    {inboxSearch && (
                      <button
                      ...
                      return (
                        <button
                          ...
                          className={`w-full p-3.5 flex items-start gap-3 text-left transition-colors cursor-pointer ${
                            isSelected ? 'bg-[#F4F0FD]' : 'hover:bg-[#F9FAFB]'
                          }`}
                        >
                          <div
                            className={`w-10 h-10 rounded-full ${
                              conv.avatarColor || 'bg-[#7C3AED]'
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center justify-between">
                              <span
                                className={`text-xs truncate ${
                                  isSelected ? 'font-extrabold text-[#7C3AED]' : 'font-bold text-[#101828]'
                                }`}
                              >
                                {conv.customerName}
                              </span>
                            ...
                            <div className="flex items-center justify-between gap-1 mt-1">
                              ...
                              {conv.unreadCount > 0 && (
                                <span className="w-4 h-4 rounded-full bg-[#7C3AED] text-white text-[9px] font-bold flex items-center justify-center shrink-0">
                                  {conv.unreadCount}
                                </span>
                              )}
                            </div>
              ...
              {/* Right Column: Chat Stream & Message Dispatcher */}
              <div className="flex-1 flex flex-col bg-[#F8FAFC]">
                {selectedConversation ? (
                  <>
                    {/* Chat Header */}
                    <div className="p-3.5 bg-white border-b border-[#EAECF0] flex items-center justify-between shadow-2xs">
                      <div className="flex items-center gap-3 min-w-0">
                        <div
                          className={`w-9 h-9 rounded-full ${
                            selectedConversation.avatarColor || 'bg-[#7C3AED]'
                        ...
                        <div className="min-w-0">
                          ...
                          <div className="text-[11px] text-[#667085] font-mono flex items-center gap-2">
                            <span>{selectedConversation.phone}</span>
                            <span>·</span>
                            <span className="text-[#16A34A] font-semibold">WhatsApp Cloud API</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          ...
                          className="px-2.5 py-1.5 rounded-xl border border-[#D0D5DD] bg-white hover:bg-[#F9FAFB] text-[#344054] text-xs font-semibold flex items-center gap-1.5 transition-colors cursor-pointer"
                          title="Edit Contact Name, Phone or Tags"
                        >
                        ...
                        <button
                          ...
                          className="p-1.5 rounded-xl border border-[#FECACA] bg-[#FEF2F2] hover:bg-[#FEE2E2] text-[#DC2626] transition-colors cursor-pointer"
                          title="Delete Conversation"
                        >
                          <Trash2 className="w-3.5 h-3.5" />
                        </button>

                        <span className="px-2.5 py-1 rounded-full text-[10px] font-mono font-bold bg-[#DCFCE7] text-[#15803D] border border-[#BBF7D0]">
                    ...
                    <div className="flex-1 overflow-y-auto p-4 space-y-3 bg-[#F8FAFC]">
                      <div className="text-center my-2">
                        <span className="px-3 py-1 rounded-full bg-white border border-[#EAECF0] text-[10px] font-mono text-[#667085] shadow-2xs">
                          End-to-end encrypted WhatsApp conversation with {selectedConversation.customerName}
                        </span>
                      </div>
                      ...
                      {selectedConversation.messages.map((m) => (
                        ...
                        >
                          <div
                            className={`max-w-[70%] rounded-2xl px-4 py-2.5 text-xs shadow-2xs ${
                              m.isOutbound
                                ? 'bg-[#7C3AED] text-white rounded-br-none'
                                : 'bg-white text-[#101828] border border-[#EAECF0] rounded-bl-none'
                            }`}
                          >
                            {m.isBot && (
                              <div className="flex items-center gap-1 text-[10px] text-[#DDD6FE] mb-1 font-semibold">
                            ...
                            {/* Translated Bubble if toggled */}
                            {translatedMessages[m.id] && (
                              <div className="mt-1.5 pt-1.5 border-t border-[#EAECF0] text-[11px] text-[#6941C6] bg-[#FAF5FF] p-2 rounded-xl">
                                <div className="flex items-center gap-1 font-bold text-[10px] text-[#7C3AED] mb-0.5">
                                  <Languages className="w-3 h-3" />
                                  <span>Translated ({LANGUAGE_OPTIONS.find((l) => l.code === targetLang)?.label}):</span>
                                </div>
                                <p className="italic">{translatedMessages[m.id]}</p>
                              </div>
                            )}

                            <div
                              className={`flex items-center justify-between gap-2 mt-1.5 text-[9px] font-mono ${
                                m.isOutbound ? 'text-white/70' : 'text-[#98A2B3]'
                              }`}
                            >
                              ...
                              {!m.isOutbound ? (
                                <button
                                  ...
                                  className="text-[10px] text-[#7C3AED] hover:underline flex items-center gap-1 font-medium cursor-pointer"
                                >
                                  <Languages className="w-3 h-3" />
                                  <span>{translatedMessages[m.id] ? 'Original' : 'Translate'}</span>
                                </button>
                              ) : (
                                <span />
                              )}
                              ...
                              <div className="flex items-center gap-1">
                                ...
                                {m.isOutbound && (
                                  <CheckCheck className="w-3.5 h-3.5 text-[#A7F3D0]" />
                                )}
                              </div>
                            </div>
                          </div>
                    ...
                    {/* Powerful Tool Bar: AI Reply, Templates, Translation, and Quick Chips */}
                    <div className="px-4 py-2 bg-white border-t border-[#F2F4F7] flex items-center gap-2 overflow-x-auto no-scrollbar">
                      {/* AI Reply Button */}
                      <button
                        type="button"
                        onClick={handleGenerateAiReply}
                        disabled={isAiGenerating}
                        className="px-3 py-1.5 rounded-xl bg-gradient-to-r from-[#7C3AED] to-[#9333EA] hover:opacity-95 text-white text-xs font-bold flex items-center gap-1.5 shadow-2xs transition-all cursor-pointer disabled:opacity-50 shrink-0"
                        title="Analyze conversation and generate smart AI response"
                      >
                        <Sparkles className={`w-3.5 h-3.5 text-yellow-300 ${isAiGenerating ? 'animate-spin' : ''}`} />
                        <span>{isAiGenerating ? 'AI Thinking...' : '✨ AI Reply'}</span>
                      </button>
                      ...
                      <button
                        ...
                        className="px-3 py-1.5 rounded-xl bg-white border border-[#D0D5DD] hover:bg-[#F9FAFB] text-[#344054] text-xs font-bold flex items-center gap-1.5 transition-all cursor-pointer shrink-0"
                        title="Choose from pre-approved WhatsApp templates"
                      >
                        <LayoutTemplate className="w-3.5 h-3.5 text-[#7C3AED]" />
                        <span>Templates</span>
                      </button>

                      {/* Translation Selector & Button */}
                      <div className="flex items-center gap-1 bg-[#F9FAFB] border border-[#EAECF0] rounded-xl p-1 shrink-0">
                        <Globe className="w-3.5 h-3.5 text-[#7C3AED] ml-1 shrink-0" />
                        <select
                          value={targetLang}
                          onChange={(e) => setTargetLang(e.target.value)}
                          className="bg-transparent text-[11px] font-bold text-[#344054] focus:outline-none cursor-pointer py-0.5 pr-1"
                        >
                        ...
                        <button
                          ...
                          disabled={isTranslating || !inboxReplyText.trim()}
                          className="px-2 py-1 rounded-lg bg-[#7C3AED] hover:bg-[#6D28D9] text-white text-[10px] font-bold flex items-center gap-1 transition-colors cursor-pointer disabled:opacity-40"
                          title="Translate draft to selected language"
                        >
                          <Languages className="w-3 h-3" />
                          <span>Translate</span>
                        </button>
                      ...
                      {[
                        ...
                        'Here are our package pricing details.',
                        'Thanks for contacting Kiki Support!',
                        'Can we schedule a quick call?',
                      ].map((chip) => (
                        <button
                          key={chip}
                          type="button"
                          onClick={() => setInboxReplyText(chip)}
                          className="px-2.5 py-1 rounded-full bg-[#F4F0FD] hover:bg-[#EDE9FE] text-[#7C3AED] text-[11px] font-medium shrink-0 transition-colors cursor-pointer border border-[#E9D8FD]"
                        >
                          {chip}
                        </button>
                      ))}
                    ...
                    <form
                      ...
                      className="p-3 bg-white border-t border-[#EAECF0] flex items-center gap-2"
                    >
                      <input
                        type="text"
                        value={inboxReplyText}
                        onChange={(e) => setInboxReplyText(e.target.value)}
                        placeholder={`Reply to ${selectedConversation.customerName} via WhatsApp...`}
                        className="flex-1 px-4 py-2.5 bg-[#F9FAFB] border border-[#D0D5DD] rounded-xl text-xs focus:ring-2 focus:ring-[#7C3AED] focus:bg-white focus:outline-none"
                      />

                      <button
                        type="submit"
                        disabled={isInboxSending || !inboxReplyText.trim()}
                        className="px-4 py-2.5 bg-[#7C3AED] hover:bg-[#6D28D9] text-white rounded-xl text-xs font-bold flex items-center gap-1.5 shadow-xs transition-colors cursor-pointer disabled:opacity-50"
                      >
                        {isInboxSending ? (
                          <RefreshCw className="w-3.5 h-3.5 animate-spin" />
                        ) : (
                  ...
                  <div className="flex-1 flex flex-col items-center justify-center text-center p-8 text-[#98A2B3]">
                    <Mail className="w-12 h-12 mb-3 opacity-30" />
                    <h3 className="text-sm font-bold text-[#344054]">No Conversation Selected</h3>
                    <p className="text-xs text-[#667085] mt-1">Select a customer chat from the list or start a new conversation.</p>
                  </div>
                )}
              </div>
            </div>
        ...
        {isNewChatModalOpen && (
          <div className="fixed inset-0 bg-black/40 backdrop-blur-xs flex items-center justify-center z-50 p-4 animate-in fade-in">
            <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-xl border border-[#EAECF0] space-y-4">
              <div className="flex items-center justify-between pb-3 border-b border-[#EAECF0]">
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded-xl bg-[#F4F0FD] text-[#7C3AED] flex items-center justify-center">
                    <UserPlus className="w-4 h-4" />
                  </div>
                  <h3 className="text-sm font-bold text-[#101828]">Start New WhatsApp Conversation</h3>
                </div>
                <button
                  onClick={() => setIsNewChatModalOpen(false)}
                  className="text-[#98A2B3] hover:text-[#344054] cursor-pointer"
                >
                  <X className="w-4 h-4" />
                </button>
              </div>
              ...
              <form onSubmit={handleStartNewChat} className="space-y-3.5">
                <div className="space-y-1">
                  <label className="text-xs font-bold text-[#344054]">Customer Name</label>
                  <input
                    type="text"
                    value={newChatName}
                    onChange={(e) => setNewChatName(e.target.value)}
                    placeholder="e.g. John Doe"
                    className="w-full px-3.5 py-2 bg-white border border-[#D0D5DD] rounded-xl text-xs focus:ring-2 focus:ring-[#7C3AED] focus:outline-none"
                  />
                </div>

                <div className="space-y-1">
                  <label className="text-xs font-bold text-[#344054]">WhatsApp Phone Number *</label>
                  <input
                    type="text"
                    value={newChatPhone}
                    onChange={(e) => setNewChatPhone(e.target.value)}
                    placeholder="+91 97914 71277 or +1 555 123 4567"
                    required
                    className="w-full px-3.5 py-2 bg-white border border-[#D0D5DD] rounded-xl text-xs font-mono focus:ring-2 focus:ring-[#7C3AED] focus:outline-none"
                  />
                </div>

                <div className="space-y-1">
                  <label className="text-xs font-bold text-[#344054]">Initial Outbound Message (Optional)</label>
                  <textarea
                    rows={2}
                    value={newChatInitialMessage}
                    onChange={(e) => setNewChatInitialMessage(e.target.value)}
                    placeholder="Hello! Reaching out regarding your inquiry..."
                    className="w-full px-3.5 py-2 bg-white border border-[#D0D5DD] rounded-xl text-xs focus:ring-2 focus:ring-[#7C3AED] focus:outline-none"
                  />
                </div>
                ...
                <div className="flex items-center justify-end gap-2 pt-2 border-t border-[#EAECF0]">
                  <button
                    type="button"
                    onClick={() => setIsNewChatModalOpen(false)}
                    className="px-4 py-2 rounded-xl border border-[#D0D5DD] hover:bg-[#F9FAFB] text-xs font-bold text-[#344054] cursor-pointer"
                  >
                    Cancel
                  </button>
                  <button
                    type="submit"
                    className="px-4 py-2 rounded-xl bg-[#7C3AED] hover:bg-[#6D28D9] text-white text-xs font-bold shadow-xs cursor-pointer"
                  >
                    Start Conversation
                  </button>
                </div>
            ...
            <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-xl border border-[#EAECF0] space-y-4">
              <div className="flex items-center justify-between pb-3 border-b border-[#EAECF0]">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="text-sm font-bold text-[#101828]">Edit Contact Details</h3>
                </div>
                <button
              ...
              <form onSubmit={handleSaveEditContact} className="space-y-3.5">
                <div className="space-y-1">
                  <label className="text-xs font-bold text-[#344054]">Contact / Company Name *</label>
                  <input
                    type="text"
                    value={editName}
                ...
                <div className="space-y-1">
                  <label className="text-xs font-bold text-[#344054]">Category / Label Tag</label>
                  <select
                    value={editTag}
                    onChange={(e) => setEditTag(e.target.value)}
                    className="w-full px-3.5 py-2 bg-white border border-[#D0D5DD] rounded-xl text-xs focus:ring-2 focus:ring-[#7C3AED] focus:outline-none cursor-pointer"
                  >
        ...
        {isTemplatesModalOpen && (
          <div className="fixed inset-0 bg-black/40 backdrop-blur-xs flex items-center justify-center z-50 p-4 animate-in fade-in">
            <div className="bg-white rounded-3xl max-w-xl w-full p-6 shadow-xl border border-[#EAECF0] space-y-4 max-h-[85vh] flex flex-col">
              <div className="flex items-center justify-between pb-3 border-b border-[#EAECF0]">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <h3 className="text-sm font-bold text-[#101828]">Pre-Approved WhatsApp Templates</h3>
                    <p className="text-[11px] text-[#667085]">Click any template to personalize and insert into composer</p>
                  </div>
                </div>
                <button
              ...
              <div className="flex-1 overflow-y-auto space-y-3 pr-1">
                {TEMPLATES_LIST.map((tpl) => (
                  <div
                    key={tpl.id}
                    className="p-4 rounded-2xl border border-[#EAECF0] hover:border-[#C4B5FD] hover:bg-[#FAF5FF]/50 transition-all space-y-2 group"
                  >
                    <div className="flex items-center justify-between">
                      <span className="text-xs font-bold text-[#101828] group-hover:text-[#7C3AED]">
                        {tpl.name}
                      </span>
                      <span className="text-[10px] font-mono font-bold bg-[#F4F0FD] text-[#7C3AED] px-2 py-0.5 rounded-full border border-[#E9D8FD]">
                        {tpl.category}
                      </span>
                    </div>
                    <p className="text-xs text-[#475467] leading-relaxed whitespace-pre-wrap">
                      {tpl.text.replace(/{{name}}/g, selectedConversation?.customerName || 'Customer')}
                    </p>
                    <div className="flex justify-end pt-1">
                      <button
                        type="button"
                        onClick={() => handleApplyTemplate(tpl.text)}
                        className="px-3 py-1.5 rounded-xl bg-[#7C3AED] hover:bg-[#6D28D9] text-white text-xs font-bold flex items-center gap-1.5 shadow-2xs transition-colors cursor-pointer"
                      >
